...
#include "ui_notifdesprovimentorecurso.h"

#include "mainwindow.h"
#include "ui_mainwindow.h"

NotifDesprovimentoRecurso::NotifDesprovimentoRecurso(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::NotifDesprovimentoRecurso)
{
    ui->setupUi(this);
...
NotifDesprovimentoRecurso::~NotifDesprovimentoRecurso()
{
    delete ui;
}

QStringList NotifDesprovimentoRecurso::getVariablesFromLayout()
{
...
QStringList NotifDesprovimentoRecurso::converteQDateEmStringList(QDate date)
{
...
void MainWindow::notificacaoDesprovimentoRecursoODT(QString fn)
{
    setupEstruturaODT();

    //QFile file("modelos/Notificação de Desprovimento de Recurso ODT/content.xml");
    ...
    stream.writeStartElement("style:style");
    stream.writeAttribute("style:name", "TableRow56");
    stream.writeAttribute("style:family", "table-row");
    ...
    stream.writeStartElement("style:style");
    stream.writeAttribute("style:name", "TableCell57");
    stream.writeAttribute("style:family", "table-cell");
    ...
    stream.writeStartElement("style:style");
    stream.writeAttribute("style:name", "TableRow82");
    stream.writeAttribute("style:family", "table-row");
    ...
    stream.writeCharacters(QString("Pela presente fica notificado(a) de que foi desprovido o recurso interposto da decisão que julgou o Auto de Infração Sanitária nº %1, de %2 de %3 de %4, tendo sido mantida(s) a(s) penalidade(s) de ").arg(numAuto).arg(diaAuto).arg(mesAuto).arg(anoAuto));
    ...
    QString equipeEnderecoFormatado;
    if (defaultEquipeComplemento.isEmpty()) {
        equipeEnderecoFormatado = QString("%1, %2, %3, %4 %5, CEP %6").arg(defaultEquipeLogradouro).arg(defaultEquipeNumero).arg(defaultEquipeBairro).arg(defaultEquipeCidade).arg(defaultEquipeEstado).arg(defaultEquipeCEP);
    } else {
        equipeEnderecoFormatado = QString("%1, %2, %3, %4, %5 %6, CEP %7").arg(defaultEquipeLogradouro).arg(defaultEquipeNumero).arg(defaultEquipeComplemento).arg(defaultEquipeBairro).arg(defaultEquipeCidade).arg(defaultEquipeEstado).arg(defaultEquipeCEP);
    }
    stream.writeStartElement("text:span");
    stream.writeAttribute("text:style-name", "T54");
    stream.writeCharacters(QString(", em arquivo PDF, assinado pelo representante legal, ou impresso na %1.").arg(equipeEnderecoFormatado));
    stream.writeEndElement(); // text:span
    ...
    stream.writeStartElement("table:table-row");
    stream.writeAttribute("table:style-name", "TableRow56");

    stream.writeStartElement("table:table-cell");
    stream.writeAttribute("table:style-name", "TableCell57");
    stream.writeAttribute("table:number-columns-spanned", "5");
    ...
    stream.writeStartElement("table:table-row");
    stream.writeAttribute("table:style-name", "TableRow82");
    ...
    // QString dirToCompress = "modelos/Notificação de Desprovimento de Recurso ODT";
...
void MainWindow::notificacaoDesprovimentoRecursoDOCX(QString fn)
{
    setupEstruturaDOCX();

    //QFile file("modelos/Notificação de Desprovimento de Recurso DOCX/word/document.xml");
    ...
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "41596CF1");
    ...
    stream.writeAttribute("w14:paraId", "55B6EF4A");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeAttribute("wp14:anchorId", "24054855");
    stream.writeAttribute("wp14:editId", "79B4997A");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "6606BFC0");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "2BF708BC");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    if (defaultEquipeTipo == "Estadual") {
        stream.writeStartElement("w:p");
        stream.writeAttribute("w14:paraId", "3F16E1EC");
        stream.writeAttribute("w14:textId", "6CCEC127");
        stream.writeAttribute("w:rsidR", "005C1E72");
        stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
        ...
        stream.writeStartElement("w:p");
        stream.writeAttribute("w14:paraId", "52D4EBC7");
        stream.writeAttribute("w14:textId", "3E017477");
        stream.writeAttribute("w:rsidR", "00D15300");
        stream.writeAttribute("w:rsidRDefault", "00D15300");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "6BE5FB77");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "70ECF12C");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "0FD61C93");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1EB53950");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "008E0B2C");
    stream.writeAttribute("w:rsidRDefault", "008E0B2C");
    stream.writeEndElement(); // w:p
    stream.writeEndElement(); // w:tc
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "29646AC9");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "0C6167C1");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "008E0B2C");
    stream.writeAttribute("w:rsidRDefault", "008E0B2C");
    stream.writeEndElement(); // w:p
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "06609E32");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "2412F57E");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "297F9D89");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "43A19937");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "0CF5C257");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1FCB6058");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "583BE60F");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "02466940");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "4B2D44DE");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "22B7DA82");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "79718D3B");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "62405C51");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "5A2285BD");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "4F6AEFB0");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "14440E04");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeCharacters(QString(" e que, de acordo com o art. 30, parágrafo único, da Lei Federal nº 6437/77, terá o prazo de 20 (vinte) dias contados do recebimento desta para, querendo, apresentar recurso perante %1 ").arg(nomeEquipeFormatado));
    stream.writeEndElement(); // w:t
    stream.writeEndElement(); // w:r
    ...
    stream.writeCharacters(QString(" pelo e-mail %1, em arquivo PDF, assinado pelo representante legal, ou impresso no(a) %2.").arg(defaultEquipeEmail).arg(enderecoEquipeFormatado));
    stream.writeEndElement(); // w:t
    stream.writeEndElement(); // w:r
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "6865EA2E");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "547A06DB");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "413F54D7");
    stream.writeAttribute("w14:textId", "77777777");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "28D5D2C2");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "2E033378");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "4BDA5803");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "126F47A1");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "521BAB7A");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "0A8E45CF");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "0F18CB8D");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "4545A049");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1B22F5FA");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "2743290D");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "568A9829");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1DFC3ED4");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "71030E00");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1D3CFEAD");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "4803033F");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "36A05DE8");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w14:paraId", "49BB7A58");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidTr", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "35A6817D");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "2ECEAC79");
    stream.writeAttribute("w14:textId", "200995C1");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "00BD1CB5");
    stream.writeAttribute("w:rsidP", "00FF6047");
    ...
    stream.writeStartElement("w:tr");
    stream.writeAttribute("w:rsidR", "00FF6047");
    stream.writeAttribute("w14:paraId", "79AB3513");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidTr", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "1A51F3C7");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "00FF6047");
    stream.writeAttribute("w:rsidRDefault", "00FF6047");
    stream.writeAttribute("w:rsidP", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "199694B1");
    stream.writeAttribute("w14:textId", "5501E545");
    stream.writeAttribute("w:rsidR", "00FF6047");
    stream.writeAttribute("w:rsidRDefault", "00FF6047");
    stream.writeAttribute("w:rsidP", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "44C568F3");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "00FF6047");
    stream.writeAttribute("w:rsidRDefault", "00FF6047");
    stream.writeAttribute("w:rsidP", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "56399237");
    stream.writeAttribute("w14:textId", "645806CB");
    stream.writeAttribute("w:rsidR", "00FF6047");
    stream.writeAttribute("w:rsidRDefault", "00FF6047");
    stream.writeAttribute("w:rsidP", "00FF6047");
    ...
    stream.writeStartElement("w:p");
    stream.writeAttribute("w14:paraId", "38515A63");
    stream.writeAttribute("w14:textId", "77777777");
    stream.writeAttribute("w:rsidR", "005C1E72");
    stream.writeAttribute("w:rsidRDefault", "005C1E72");
    ...
    //QString dirToCompress = "modelos/Notificação de Desprovimento de Recurso DOCX";
